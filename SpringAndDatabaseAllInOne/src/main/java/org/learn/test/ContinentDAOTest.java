...
public class ContinentDAOTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Result from Single query with ID : " + "ID : " + continent.getId() + " Name : "
					+ continent.getName());
			...
			System.out.println(
					"Number of row affected batch Insert : " + (continentDAO.createBatch(continentList)).length);
