...
public class ContinentDAOTransactionTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println(
					"======  Insert batch continent ( nothing will be inserted to Db for transaction) =========");

			List<Continent> continentList = new ArrayList<>();
			continentList.add(new Continent(19, "Asia1")); // Provide a valid
															// Data
			continentList.add(new Continent(10, "Asi2")); // Provide invalid
															// data, Example :
															// data with dupe PK
			System.out.println("Number of row affected batch Insert : "
					+ (continentDAO.createBatchWithTransaction(continentList)).length);
